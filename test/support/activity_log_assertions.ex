defmodule PhoenixKitComments.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitComments.DataCase` and
  `PhoenixKitComments.LiveCase` so every DB-backed test can reach
  them.
  """
